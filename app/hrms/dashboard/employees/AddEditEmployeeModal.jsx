...
export default function AddEditEmployeeModal({
  ...
  const isSuperAdminOrHR = user?.userRole?.some(role => 
  ...
  // ✅ Initialize completed steps when in edit mode
  useEffect(() => {
    if (mode === "edit" && employee) {
      // Mark all steps as completed since employee exists
      setCompletedSteps([1, 2, 3, 4, 5]);
    }
  }, [mode, employee]);

  // ✅ Enhanced canEditStep function
  const canEditStep = (stepNumber) => {
    if (mode === "view") return false;
    if (mode === "add") return stepNumber === step; // In add mode, only current step
    
    // In edit mode
    if (isSuperAdminOrHR) {
      return true; // SuperAdmin and HR can edit all steps
    }
    
    // Regular employees can only edit step 1 and step 5
    // But they should be able to navigate to steps 2-4 to see the errors
    return stepNumber === 1 || stepNumber === 5;
  };

  // ✅ Enhanced isFieldReadonly function
  const isFieldReadonly = (stepNumber, fieldName = null) => {
    if (mode === "view") return true;
    if (mode === "add") return false;
    
    // Email is always readonly in edit mode (step 1)
    if (stepNumber === 1 && fieldName === "email") return true;
    
    return !canEditStep(stepNumber);
  };
      ...
      >
        <div className="flex items-center justify-between px-5 py-3 border-b border-gray-100 sticky top-0 bg-white z-10">
          <div>
            ...
            <div className="text-sm text-[var(--color-primaryText)] mt-1">
              Multi-step employee form
              {/* ✅ Show permission indicator for non-admin users */}
              {mode === "edit" && !isSuperAdminOrHR && (
            ...
            {[1, 2, 3, 4, 5].map((s, index) => (
              <React.Fragment key={s}>
                ...
                <div
                  ...
                  onClick={() => {
                    if (!isView) {
                      // Allow navigation to any step, but editing depends on permissions
                      setStep(s);
                    }
                  }}
                >
                  <div
                    ...
                    title={!canEditStep(s) && s !== step ? "Read-only - Contact HR/Admin to edit" : ""}
                  >
                    {s}
                  </div>
                  <div className="text-sm text-[var(--color-primaryText)] whitespace-nowrap">
                    {s === 1
                      ...
                      ? "Credentials"
                      : "Documents"}
                    {mode === "edit" && !isSuperAdminOrHR && s !== 1 && s !== 5 && (
                      <span className="ml-1 text-xs text-amber-600">(Read-only)</span>
                    )}
                  </div>
                </div>
              </React.Fragment>
          ...
          <div className="mx-6 mt-4 p-4 bg-red-50 border border-red-200 rounded-lg">
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1">
                ...
                {mode === "edit" && !isSuperAdminOrHR && step !== 1 && step !== 5 && (
                  <div className="mt-2 p-2 bg-amber-50 border border-amber-200 rounded text-amber-700 text-sm">
                    <p>Some fields cannot be edited. Contact HR/Admin to make changes to these sections.</p>
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <div className="flex items-center justify-center">
                  <div
                    className="relative w-32 h-32 rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 flex items-center justify-center cursor-pointer overflow-hidden"
                    onMouseEnter={() => !isView && canEditStep(1) && setImageHovered(true)}
                    onMouseLeave={() => !isView && canEditStep(1) && setImageHovered(false)}
                  >
                    {imagePreview ? (
                      <Image
                        src={imagePreview}
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "firstName")}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "lastName")}
                />
              </div>

              {/* Email - readonly for employees in edit mode */}
              <div>
                <label className="text-sm text-[var(--color-primaryText)]">
                  Email address <span className="text-red-500">*</span>
                </label>
                <input
                  ...
                  readOnly={isFieldReadonly(1, "email")}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "dateOfBirth")}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "mobileNumber")}
                  placeholder="+1234567890"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "alternateMobileNumber")}
                  placeholder="+1234567890"
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  rows={3}
                  className="mt-1 w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-0 focus:border-[var(--color-primary)]"
                  readOnly={isFieldReadonly(1, "about") || sameAsCurrentAddress}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "addressLine") || sameAsCurrentAddress}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "locality") || sameAsCurrentAddress}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "city") || sameAsCurrentAddress}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "state")}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="ZIP/Postal code"
                  className={`mt-1 w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-0 focus:border-[var(--color-primary)] ${
                    errors["address[0].postalCode"] ? "border-red-500" : ""
                  }`}
                  readOnly={isFieldReadonly(1, "postalCode")}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "country") || sameAsCurrentAddress}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "permanentAddressLine") || sameAsCurrentAddress}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "permanentLocality") || sameAsCurrentAddress}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "permanentCity") || sameAsCurrentAddress}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "permanentState") || sameAsCurrentAddress}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "permanentPostalCode") || sameAsCurrentAddress}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "permanentCountry") || sameAsCurrentAddress}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "emergencyContactName")}
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className={`mt-1 w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-0 focus:border-[var(--color-primary)] ${
                    errors["emergencyContacts[0].relationship"] ? "border-red-500" : ""
                  }`}
                  disabled={!canEditStep(1)}
                >
                  <option value="">Select Relationship</option>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "emergencyContactPhone")}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isFieldReadonly(1, "emergencyContactEmail")}
                />
              </div>
            </div>
          </div>
          ...
          <div hidden={step !== 2}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {/* Show warning for regular employees */}
              {mode === "edit" && !isSuperAdminOrHR && (
                <div className="md:col-span-2 mb-4 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                  <div className="flex items-start gap-2">
                    <svg className="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                    </svg>
                    <div>
                      <p className="text-sm text-amber-800 font-medium">Read-only Section</p>
                      <p className="text-sm text-amber-700 mt-1">
                        This section cannot be edited. Contact HR/Admin to make changes to employment details.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <select
                  ...
                  className={`mt-1 w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-0 focus:border-[var(--color-primary)] ${
                    errors.userRole ? "border-red-500" : ""
                  } ${!canEditStep(2) ? "bg-gray-100 cursor-not-allowed" : ""}`}
                  disabled={isView || !canEditStep(2)}
                >
                  <option value="">Select role</option>
                  {organizationData?.roles?.map((d) => (
                    <option key={d._id} value={d.name}>
                ...
                {!canEditStep(2) && errors.userRole && (
                  <p className="text-amber-600 text-sm mt-1">
                    This field has an error. Contact HR/Admin to fix it.
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {!canEditStep(2) && errors.employmentType && (
                  <p className="text-amber-600 text-sm mt-1">
                    This field has an error. Contact HR/Admin to fix it.
                  </p>
                )}
              ...
              <div>
                ...
                {!canEditStep(2) && errors.employmentStatus && (
                  <p className="text-amber-600 text-sm mt-1">
                    This field has an error. Contact HR/Admin to fix it.
                  </p>
                )}
              ...
              <div>
                ...
                {!canEditStep(2) && errors.experienceLevel && (
                  <p className="text-amber-600 text-sm mt-1">
                    This field has an error. Contact HR/Admin to fix it.
                  </p>
                )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2 mb-4 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-sm text-amber-800 font-medium">Read-only Section</p>
                      <p className="text-sm text-amber-700 mt-1">
                        This section cannot be edited. Contact HR/Admin to make changes to job details.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <select
                  ...
                  className={`mt-1 w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-0 focus:border-[var(--color-primary)] ${
                    errors.departmentId ? "border-red-500" : ""
                  } ${!canEditStep(3) ? "bg-gray-100 cursor-not-allowed" : ""}`}
                  disabled={isView || !canEditStep(3)}
                >
                  <option value="">Select Department</option>
                  {organizationData?.departments?.map((d) => (
                    <option key={d._id} value={d._id}>
                ...
                {!canEditStep(3) && errors.departmentId && (
                  <p className="text-amber-600 text-sm mt-1">
                    This field has an error. Contact HR/Admin to fix it.
                  </p>
                )}
              ...
              <div>
                ...
                {!canEditStep(3) && errors.designationId && (
                  <p className="text-amber-600 text-sm mt-1">
                    This field has an error. Contact HR/Admin to fix it.
                  </p>
                )}
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={isView || !canEditStep(3)}
                />
                {!canEditStep(3) && errors.dateOfJoining && (
                  <p className="text-amber-600 text-sm mt-1">
                    This field has an error. Contact HR/Admin to fix it.
                  </p>
                )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2 mb-4 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-sm text-amber-800 font-medium">Read-only Section</p>
                      <p className="text-sm text-amber-700 mt-1">
                        This section cannot be edited. Contact HR/Admin to make changes to credentials.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={`mt-1 w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-0 focus:border-[var(--color-primary)] ${
                    errors.employeeId ? "border-red-500" : ""
                  } ${!canEditStep(4) ? "bg-gray-100 cursor-not-allowed" : ""}`}
                  readOnly={isView || !canEditStep(4)}
                />
                {errors.employeeId && (
                  <p className={`text-sm mt-1 ${!canEditStep(4) ? "text-amber-600" : "text-red-500"}`}>
                    {!canEditStep(4) ? "This field has an error. Contact HR/Admin to fix it." : errors.employeeId}
                  </p>
                )}
              </div>
              ...
              {/* Password field in add mode - always editable */}
              {!isView && mode === "add" && (
                <div className="md:col-span-2">
                  <label className="text-sm text-[var(--color-primaryText)]">
                    Password <span className="text-red-500">*</span>
              ...
              {/* Password field in view mode - always readonly */}
              {isView && (
                <div className="md:col-span-2">
                  <label className="text-sm text-[var(--color-primaryText)]">
                    Password
                  ...
                  <div className="md:col-span-2 space-y-4">
                    ...
                    >
                      <button
                        type="button"
                        onClick={() => toggleDocSection("idProofs")}
                        disabled={isDisabled || !canEditStep(5)}
                        className={`w-full p-4 flex items-start justify-between ${
                          isDisabled || !canEditStep(5) ? "cursor-not-allowed" : "cursor-pointer hover:bg-blue-100"
                        }`}
                      >
                        <div className="flex items-start gap-3">
                          <div className="mt-0.5">
                      ...
                      {expandedDocSections.idProofs && !isDisabled && canEditStep(5) && (
                        <div className="border-t border-blue-200 p-4 space-y-4 bg-white">
                          {renderDocumentField("Aadhaar Card", "idProofs.aadhaar")}
                          {renderDocumentField("PAN Card", "idProofs.pan")}
                          {renderDocumentField("Passport / Driving License / Voter ID", "idProofs.passportOrDL")}
                    ...
                    {requiredDocs.showAcademicSection && (
                      ...
                      >
                        ...
                        {expandedDocSections.academicDocuments && !isDisabled && canEditStep(5) && (
                          <div className="border-t border-blue-200 p-4 space-y-6 bg-white">
                            {form.employmentType === 'Internship' ? (
                              <div className="border rounded-lg p-4 bg-gray-50">
                                <h5 className="font-semibold text-gray-900 mb-3">No Objection Certificate (NOC)</h5>
                    ...
                    {requiredDocs.employmentHistory && (
                      ...
                      >
                        ...
                        {expandedDocSections.employmentHistory && !isDisabled && canEditStep(5) && (
                          <div className="border-t border-blue-200 p-4 space-y-6 bg-white">
                            {uploadedDocuments.employmentHistory?.map((employment, idx) => (
                              <div key={idx} className="border rounded-lg p-4 bg-gray-50">
                                <div className="flex items-center justify-between mb-3">
