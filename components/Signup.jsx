...
//   // States for Google Signup Modal
...
//     try {
//       const payload = {
//         firstName: googleUserData.firstName.trim(),
//         lastName: googleUserData.lastName.trim(),
//         email: googleUserData.email.trim(),
//       };

//       // Call your API to create account with Google data
//       const response = await userService.registerWithGoogle(payload);
...
//   const handleOTPVerify = async (email, otpString) => {
...
//     try {
//       const response = await userService.resendOtp(googleUserData.email);
//     } catch (error) {
//       const message =
//         error?.response?.data?.message ||
//         "Something went wrong. Please try again.";
...
//         onUserDataChange={setGoogleUserData}
//         onCreateAccount={handleCreateGoogleAccount}
