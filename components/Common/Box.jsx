...
const Box =({bgClass,borderClass,title,description,img,alt,maxHeight=220})=>{
    ...
    return(
            <article className={` ${bgClass} border-2 ${borderClass} rounded-3xl px-8 pt-8 min-h-[360px] flex flex-col transition-all duration-300 hover:scale-105 hover:shadow-xl`}>
