...
import MoondiveAdmin from '../../public/Dashboard/MoondiveLogo.svg';
  ...
  return (
    <div className='h-full flex flex-col'>
      <div className='flex-1 min-h-0 flex flex-col relative'>
        ...
        <nav className='px-1 pb-4 flex-1 mt-3 min-h-0 overflow-y-auto hide-scrollbar'>
              ...
              return (
                <li key={item.label}>
                  <Link
                    href={item.href}
                    title={item.label}
                    className={linkLayoutClass(isActive)}
                  >
