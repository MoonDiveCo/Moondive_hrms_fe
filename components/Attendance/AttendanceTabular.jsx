  ...
  const styles = {
    ...
    'Half Day': 'bg-orange-100 text-orange-700 border-orange-300',
        'Holiday': 'bg-blue-100 text-blue-700 border-blue-300',
                'Optional Holiday': 'bg-blue-100 text-blue-700 border-blue-300',
...
export default function AttendanceTabular({ currentDate, rangeMode = 'week' }) {
  ...
  const rows = eachDayOfInterval({
    ...
    else if (holidayMap[key]?.type==="PUBLIC" ) status = 'Holiday';
    else if(holidayMap[key]?.type==="OPTIONAL" && holidayMap[key].isActive ) status ='Optional Holiday'
