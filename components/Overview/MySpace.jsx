...
import { Building, Building2, Calendar, Contact2, Dot, MailIcon, MapPin, PencilIcon, PhoneCallIcon } from "lucide-react";
...
const avatarUrl = "https://img.freepik.com/free-photo/young-entrepreneur_1098-18139.jpg?semt=ais_se_enriched&w=740&q=80";
...
const myTotalLeavesCount = Array.isArray(leaveData?.leaves)
 ...
 if(loading){
  ...
  const attendanceItems = getCurrentWorkWeekDays().map((d) => {
    ...
    const totalHours = workedSeconds > 0 
    ...
    <div className="max-w-full mx-auto px-6 md:px-8 p-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-primaryText">
                        ...
                        {member._id === user?._id && (
                          <span className="text-xs text-orange-600 font-medium ml-2">(You)</span>
                        )}
                      </p>
                      <p className="text-xs text-gray-500">
      ...
      <section className="mt-8">
        ...
        <div className="bg-white rounded-lg primaryShadow overflow-hidden">
              ...
              {tabs.map((t) => {
                ...
                return (
                  <button
                    ...
                    className={`relative pb-3 px-3 transition-colors ${isActive ? "font-semibold text-primaryText" : "text-gray-500"} hover:text-primaryText`}
                    style={{ borderBottom: isActive ? "3px solid var(--color-primary)" : "3px solid transparent" }}
                  >
          ...
          <div className="p-6">
            {activeTab === "leave" && <LeaveTrackerDashboard showCalender={false} />}
            {activeTab === "feeds" && <p className="text-gray-500">No feeds yet.</p>}
            {activeTab === "profile" && <p className="text-gray-500">Profile section here.</p>}

            {activeTab === "approvals" && (
              <div className="space-y-4"> 
                {approvalsLoading ? (
                  <p className="text-center py-12 text-primaryText">Loading approvals...</p>
                ) : pendingApprovals.length === 0 ? (
                  <p className="text-center py-16 text-primaryText">No pending leave requests</p>
                ) : (
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <p className="font-semibold text-primaryText">{req.employeeName}</p>
                            <p className="text-sm text-primaryText mt-1">
                              {req.leaveType} • {dayjs(req.startDate).format("MMM DD, YYYY")}
                            </p>
            ...
            {activeTab === "files" && <p className="text-gray-500">Files list.</p>}
          </div>
        </div>
      </section>
      ...
      {isModalOpen && selectedLeave && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 relative">
            ...
            <h3 className="text-xl font-bold text-primaryText mb-6">Leave Request Details</h3>
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {selectedLeave.leaveType} • {dayjs(selectedLeave.startDate).format("MMM DD, YYYY")}
                </p>
              </div>
            </div>
            ...
            {selectedLeave.reason && (
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                <p className="text-sm italic text-gray-700">"{selectedLeave.reason}"</p>
              </div>
            )}
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6">
            <h4 className="text-md font-bold text-primaryText mb-4">
              Are you sure you want to {confirmAction === "approve" ? "approve" : "reject"} this leave request?
            </h4>
      ...
      <ProfileSlideOver isOpen={openProfile} onClose={() => setOpenProfile(false)} startInEdit={true} />
    </div>
  );
}