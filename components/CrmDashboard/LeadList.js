...
const handleConfirmCall = async (e) => {
  ...
  try {
    ...
    console.log("Meeting scheduled successfully:", res.data);
  ...
  // Show "No leads" only when not loading
  ...
  return (
    <>
      <div className="relative">
        {/* Loader overlay – keeps layout fixed while loading */}
        {loading && (
              ...
              <tr>
                {showSelection && (
                  <th className="px-6 py-3 w-10">
                    {/* header checkbox if needed later */}
                  </th>
                )}
