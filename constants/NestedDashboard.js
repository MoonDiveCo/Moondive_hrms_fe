...
export const ACTION_PERMISSIONS = {
  ...
  CMS_GENAI_VISIBILITY_WRITE:'CMS_GENAI_VISIBILITY:WRITE',
  CMS_GENAI_VISIBILITY_EDIT:'CMS_GENAI_VISIBILITY:EDIT',
  CMS_GENAI_VISIBILITY_DELETE:'CMS_GENAI_VISIBILITY:DELETE',
