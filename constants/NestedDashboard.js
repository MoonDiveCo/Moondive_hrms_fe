...
export const ACTION_PERMISSIONS = {
  ...
  HRMS_ORGANIZATION_VIEW: 'HRMS:ORGANIZATION:VIEW',
  HRMS_ORGANIZATION_EDIT: 'HRMS:ORGANIZATION:EDIT',
  ...
  HRMS_DESIGNATION_EDIT: 'HRMS:DESIGNATION:EDIT',
  ...
  HRMS_DEPARTMENT_EDIT: 'HRMS:DEPARTMENT:EDIT',
  ...
  HRMS_ROLE_VIEW: 'HRMS:ROLE:VIEW',
  HRMS_ROLE_WRITE: 'HRMS:ROLE:WRITE',
  HRMS_ROLE_EDIT: 'HRMS:ROLE:EDIT',
  HRMS_ROLE_DELETE: 'HRMS:ROLE:DELETE',

  HRMS_PERMISSION_VIEW: 'HRMS:PERMISSION:VIEW',
  HRMS_PERMISSION_DELETE: 'HRMS:PERMISSION:DELETE',
  HRMS_PERMISSION_EDIT: 'HRMS:PERMISSION:EDIT',
  ...
  HRMS_POLICY_VIEW: 'HRMS_POLICY_VIEW',
  HRMS_ORGANIZATION_POLICY_EDIT:'HRMS_ORGANIZATION_POLICY_EDIT',
  HRMS_ORGANIZATION_POLICY_WRITE:'HRMS_ORGANIZATION_POLICY_WRITE',
  HRMS_ORGANIZATION_POLICY_DELETE:'HRMS_ORGANIZATION_POLICY_WRITE',
...
export const ROLE_ACTION_PERMISSIONS = {
  ...
  ADMIN: [
    ...
    ACTION_PERMISSIONS.HRMS_LOCATION_VIEW,
    ACTION_PERMISSIONS.HRMS_LOCATION_EDIT,

    ACTION_PERMISSIONS.HRMS_DEPARTMENT_VIEW,
    ACTION_PERMISSIONS.HRMS_DEPARTMENT_EDIT,

    ACTION_PERMISSIONS.HRMS_DESIGNATION_VIEW,
    ACTION_PERMISSIONS.HRMS_DESIGNATION_WRITE,
    ACTION_PERMISSIONS.HRMS_DESIGNATION_EDIT,

    ACTION_PERMISSIONS.HRMS_ORGANIZATION_VIEW,
  ],
  ...
  HR: [
    ...
    ACTION_PERMISSIONS.HRMS_ROLE_VIEW,
    ACTION_PERMISSIONS.HRMS_ROLE_WRITE,
    ACTION_PERMISSIONS.HRMS_ROLE_EDIT,
    ACTION_PERMISSIONS.HRMS_ROLE_DELETE,

    ACTION_PERMISSIONS.HRMS_PERMISSION_VIEW,
    ACTION_PERMISSIONS.HRMS_PERMISSION_DELETE,
  ],
