...
export const ACTION_PERMISSIONS = {
  ...
  HRMS_EMPLOYES_VIEW: 'HRMSEMPLOYEESVIEW',
  HRMS_EMPLOYES_WRITE: 'HRMSEMPLOYEESWRITE',
  HRMS_EMPLOYES_EDIT: 'HRMSEMPLOYEESEDIT',
  HRMS_EMPLOYES_DELETE: 'HRMSEMPLOYEESDELETE',
