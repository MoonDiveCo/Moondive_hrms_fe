...
export const ACTION_PERMISSIONS = {
  ...
  HRMS_HR_HELPDESK_WRITE:"HRMS:HR_HELPDESK:WRITE",
  HRMS_HR_HELPDESK_EDIT:"HRMS:HR_HELPDESK:EDIT",
  HRMS_HR_HELPDESK_DELETE:"HRMS:HR_HELPDESK:DELETE",
  ...
  // Payroll Module
  HRMS_PAYROLL_SALARY_VIEW:   'HRMS:PAYROLL_SALARY:VIEW',
  HRMS_PAYROLL_SALARY_WRITE:  'HRMS:PAYROLL_SALARY:WRITE',
  HRMS_PAYROLL_SALARY_EDIT:   'HRMS:PAYROLL_SALARY:EDIT',
  HRMS_PAYROLL_SALARY_DELETE: 'HRMS:PAYROLL_SALARY:DELETE',
  HRMS_PAYROLL_VIEW:          'HRMS:PAYROLL:VIEW',
  HRMS_PAYROLL_WRITE:         'HRMS:PAYROLL:WRITE',
  HRMS_PAYROLL_EDIT:          'HRMS:PAYROLL:EDIT',
  HRMS_PAYROLL_SEND:          'HRMS:PAYROLL:SEND',
  HRMS_PAYROLL_DELETE:        'HRMS:PAYROLL:DELETE',

  // HR Docs Module
  HRMS_HR_DOCS_VIEW: 'HRMS:HR_DOCS:VIEW',
  HRMS_HR_DOCS_WRITE: 'HRMS:HR_DOCS:WRITE',
  HRMS_HR_DOCS_EDIT: 'HRMS:HR_DOCS:EDIT',
  HRMS_HR_DOCS_DELETE: 'HRMS:HR_DOCS:DELETE',
  HRMS_TEMPLATES_VIEW: 'HRMS:TEMPLATES:VIEW',
  HRMS_TEMPLATES_WRITE: 'HRMS:TEMPLATES:WRITE',
  HRMS_TEMPLATES_EDIT: 'HRMS:TEMPLATES:EDIT',
  HRMS_TEMPLATES_DELETE: 'HRMS:TEMPLATES:DELETE',
  HRMS_ONBOARDING_SOP_VIEW: 'HRMS:ONBOARDING_SOP:VIEW',
  HRMS_ONBOARDING_SOP_WRITE: 'HRMS:ONBOARDING_SOP:WRITE',
  HRMS_ONBOARDING_SOP_EDIT: 'HRMS:ONBOARDING_SOP:EDIT',
  HRMS_ONBOARDING_SOP_DELETE: 'HRMS:ONBOARDING_SOP:DELETE',
  ...
  CRM_IN_PROCESS_WRITE: 'CRM:IN_PROCESS:WRITE',
  CRM_IN_PROCESS_EDIT: 'CRM:IN_PROCESS:EDIT',
  CRM_IN_PROCESS_DELETE: 'CRM:IN_PROCESS:DELETE',

  CRM_MEETING_SCHEDULE_VIEW: 'CRM:MEETING_SCHEDULE:VIEW',
  CRM_MEETING_SCHEDULE_WRITE: 'CRM:MEETING_SCHEDULE:WRITE',
  CRM_MEETING_SCHEDULE_EDIT: 'CRM:MEETING_SCHEDULE:EDIT',
  CRM_MEETING_SCHEDULE_DELETE: 'CRM:MEETING_SCHEDULE:DELETE',

  CRM_FINALISED_VIEW: 'CRM:FINALISED:VIEW',
  CRM_FINALISED_WRITE: 'CRM:FINALISED:WRITE',
  CRM_FINALISED_EDIT: 'CRM:FINALISED:EDIT',
  CRM_FINALISED_DELETE: 'CRM:FINALISED:DELETE',
};
