...
export const ACTION_PERMISSIONS = {
  ...
  HRMS_EMPLOYES_VIEW: 'HRMS:EMPLOYEES:VIEW',
  HRMS_EMPLOYES_WRITE: 'HRMS:EMPLOYEES:WRITE',
  HRMS_EMPLOYES_EDIT: 'HRMS:EMPLOYEES:EDIT',
  HRMS_EMPLOYES_DELETE: 'HRMS:EMPLOYEES:DELETE',
  ...
  HRMS_PROJECTS_VIEW:'HRMS:PROJECTS:VIEW',
  HRMS_PROJECTS_EDIT:'HRMS:PROJECTS:EDIT',
  HRMS_PROJECTS_WRITE:'HRMS:PROJECTS:WRITE',
  HRMS_PROJECTS_DELETE:'HRMS:PROJECTS:DELETE',
  ...
  HRMS_HR_HELPDESK_VIEW:"HRMS:HR HELPDESK:VIEW",
